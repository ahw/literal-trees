define([], function() {
     ...
     * @constructor
     */
    utils.LinearTransform = function (domain, range, x) {
        // rise / run
    ...
    utils.rgb2hex = function (r, g, b) {
        return "#" + utils.decimal2hex(r) + utils.decimal2hex(g) + utils.decimal2hex(b);
    };
